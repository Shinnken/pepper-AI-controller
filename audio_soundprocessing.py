...
class SoundProcessingModule(object):
    ...
    def __init__( self, app, name="SoundProcessingModule"):
        """
    ...
    def startProcessing(self):
        ...
        print("[SoundProcessingModule] Subscribed to ALAudioDevice.")
        while self.isProcessingDone == False:
            time.sleep(1)

        print("[SoundProcessingModule] Processing done.")
    ...
    def processRemote(self, nbOfChannels, nbOfSamplesByChannel, timeStamp, inputBuffer):
        ...
        """
        print("frames count = ", + str(self.framesCount))
    ...
    def getBuffer(self):
        ...
        if self.inputBuffer is not None:
            buff = self.inputBuffer
            self.inputBuffer = None  # Clear the buffer after returning it
            return buff
        else:
            print("[SoundProcessingModule] No audio buffer available.")
            return None
